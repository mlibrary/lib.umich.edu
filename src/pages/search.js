...
import { Heading, Text, SPACING, Margins, COLORS } from '@umich-lib/core'
  ...
  return (
    <Layout>
      ...
      >
        ...
        <Text lede css={{ maxWidth: '100%', color: COLORS.neutral['300'] }}>
          We're still figuring out how we want to implement this.
        </Text>
      </Margins>
    </Layout>
  )
