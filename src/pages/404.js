    ...
    <Layout>
      ...
      <Margins css={{
        ...
        <Heading size="3XL" level="1" css={{ marginBottom: SPACING['M'] }}>
          ...
          </span>Page not found</Heading>
        <Prose css={{
          marginBottom: '8rem'
        }}>
          <Text lede>We can’t find the page you’re looking for. This can sometimes happen when:</Text>
    ...
    <div 
      css={{
        ...
        [MEDIA_QUERIES['M']]: {
          ...
          shapeOutside: 'polygon(65px 381px, 84px 210px, -18px 211px, -35px 141px, -11px 106px, 103px 115px, 123px 96px, 189px 111px, 262px 27px, 266px -14px, 313px -30px, 427px -29px, 475px 18px, 456px 75px, 458px 177px, 504px 163px, 632px 171px, 632px 225px, 536px 235px, 524px 490px, 44px 491px)',
          marginBottom: 0
        },
        [MEDIA_QUERIES['L']]: {
          width: '50vw',
